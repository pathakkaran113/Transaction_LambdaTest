...
//     clientID:  '315558729563-1faqde4j7h4nfb1clegrneaho4goock6.apps.googleusercontent.com', // '1053283576174-vnbi7rpopcsie7c8o9vsm1kj38ihr4c1.apps.googleusercontent.com',
//     clientSecret: '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', //'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',
//     callbackURL: 'http://localhost:2020/oauth2callback'
...
// //x-app.use(session(sessionOptions));
...
//   const { endDate } = req.query;
//   try {
//     const startDate =  "2024-07-05"  //await fetchStartDate();
//     console.log('Start Date:', startDate);
...
app.get('/fetch-transactions', async (req, res) => {
  const { endDate } = req.query;
  try {
    const startDate = "2024-07-05";  // Replace with actual logic to fetch start date
    console.log('Start Date:', startDate);
